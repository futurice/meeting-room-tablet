...
public class RoomTrafficLights extends RelativeLayout {
    ...
    public RoomTrafficLights(Context context, AttributeSet attrs) {
        ...
        quickBookView = (Button) findViewById(R.id.quickBook);
        ...
        quickBookView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (bookNowListener != null && quickBookView.getVisibility() == VISIBLE) {
    ...
    public void update(Room room) {
        ...
        if (room.isBookable(QUICK_BOOK_THRESHOLD)) {
            ...
            if (room.isFreeRestOfDay()) {
                ...
                quickBookView.setBackgroundDrawable(getResources().getDrawable(R.drawable.traffic_lights_button_green));
                quickBookView.setTextColor(getResources().getColorStateList(R.color.traffic_lights_button_green));
            } else {
                ...
                if (freeMinutes >= Room.RESERVED_THRESHOLD_MINUTES) {
                    ...
                    quickBookView.setBackgroundDrawable(getResources().getDrawable(R.drawable.traffic_lights_button_yellow));
                    quickBookView.setTextColor(getResources().getColorStateList(R.color.traffic_lights_button_yellow));
                }
            }
            reservationInfoView.setVisibility(GONE);
            roomStatusInfoView.setVisibility(VISIBLE);
            quickBookView.setVisibility(VISIBLE);
        } else {
            this.setBackgroundColor(getResources().getColor(R.color.TrafficLightReserved));
            roomStatusView.setText("Reserved");
            quickBookView.setVisibility(GONE);
    ...
    private void updateConnected() {
        ...
        String lastSyncedText = "Last synced: " + lastTimeConnected.toString();
        lastSync.setText(lastSyncedText);
    }
